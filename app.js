...
app.get('/post/:test', (req, res) => {
  let i = 0;
  let browserString = lodash.lowerCase(req.params.test);
  for(i=0;i<posts.length;i++) {
    let titleString = lodash.lowerCase(posts[i].title);
    if(titleString === browserString) {
      res.render('post', {
        title : posts[i].title,
        post : posts[i].postContent
      })
      break;
    }
  }
...
app.post('/compose', (req, res) => {
  ...
  //   inputInfo.postContent = req.body.postcontent.substring(0,100) + " ...";
  // }
